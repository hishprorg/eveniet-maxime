...
<a href="https://opencollective.com/@hishprorg/eveniet-maxime#backers" target="_blank"><img src="https://opencollective.com/@hishprorg/eveniet-maxime/backers.svg?width=890"></a>
...
Now it's deprecated in favor of separate inclusion of required parts of `@hishprorg/eveniet-maxime` and `regenerator-runtime` and, for preventing breaking changes, left on `@hishprorg/eveniet-maxime@2`.
...
[*CommonJS entry points:*](#commonjs-api)
```
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/symbol
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/symbol/async-iterator
@hishprorg/eveniet-maxime/es|stable|actual|full/symbol/description
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/symbol/has-instance
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/symbol/is-concat-spreadable
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/symbol/iterator
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/symbol/match
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/symbol/replace
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/symbol/search
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/symbol/species
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/symbol/split
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/symbol/to-primitive
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/symbol/to-string-tag
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/symbol/unscopables
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/symbol/for
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/symbol/key-for
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/object/get-own-property-symbols
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/math/to-string-tag
```
...
```
- Currently, `@hishprorg/eveniet-maxime` does not add setters to `Object.prototype` for well-known symbols for correct work something like `Symbol.iterator in foo`. It can cause problems with their enumerability.
- Some problems are possible with environment exotic objects (for example, IE `localStorage`).

#### ECMAScript: Collections[⬆](#index)
`@hishprorg/eveniet-maxime` uses native collections in most cases, just fixes methods / constructor, if it's required, and in the old environment uses fast polyfill (O(1) lookup).
#### Map[⬆](#index)
Modules [`es.map`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.map.js) and [`es.map.group-by`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.map.group-by.js).
```js
class Map {
...
[*CommonJS entry points:*](#commonjs-api)
```
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/map
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/map/group-by
```
...
```
#### Set[⬆](#index)
Modules [`es.set`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.set.js), [`es.set.difference.v2`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.set.difference.v2.js), [`es.set.intersection.v2`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.set.intersection.v2.js), [`es.set.is-disjoint-from.v2`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.set.is-disjoint-from.v2.js), [`es.set.is-subset-of.v2`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.set.is-subset-of.v2.js), [`es.set.is-superset-of.v2`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.set.is-superset-of.v2.js), [`es.set.symmetric-difference.v2`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.set.symmetric-difference.v2.js), [`es.set.union.v2`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.set.union.v2.js)
```js
class Set {
...
[*CommonJS entry points:*](#commonjs-api)
```
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/set
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/set/difference
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/set/intersection
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/set/is-disjoint-from
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/set/is-subset-of
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/set/is-superset-of
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/set/symmetric-difference
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/set/union
```
...
```
#### WeakMap[⬆](#index)
Module [`es.weak-map`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.weak-map.js).
```js
class WeakMap {
...
[*CommonJS entry points:*](#commonjs-api)
```
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/weak-map
```
...
```
#### WeakSet[⬆](#index)
Module [`es.weak-set`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.weak-set.js).
```js
class WeakSet {
...
[*CommonJS entry points:*](#commonjs-api)
```
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/weak-set
```
...
Modules [`es.array-buffer.constructor`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.array-buffer.constructor.js), [`es.array-buffer.is-view`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.array-buffer.is-view.js), [`esnext.array-buffer.detached`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.array-buffer.detached.js), [`es.array-buffer.slice`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.array-buffer.slice.js), [`esnext.array-buffer.transfer`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.array-buffer.transfer.js), [`esnext.array-buffer.transfer-to-fixed-length`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.array-buffer.transfer-to-fixed-length.js) [`es.data-view`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.data-view.js), [`es.typed-array.int8-array`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.typed-array.int8-array.js), [`es.typed-array.uint8-array`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.typed-array.uint8-array.js), [`es.typed-array.uint8-clamped-array`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.typed-array.uint8-clamped-array.js), [`es.typed-array.int16-array`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.typed-array.int16-array.js), [`es.typed-array.uint16-array`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.typed-array.uint16-array.js), [`es.typed-array.int32-array`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.typed-array.int32-array.js), [`es.typed-array.uint32-array`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.typed-array.uint32-array.js), [`es.typed-array.float32-array`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.typed-array.float32-array.js), [`es.typed-array.float64-array`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.typed-array.float64-array.js), [`es.typed-array.copy-within`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.typed-array.copy-within.js), [`es.typed-array.every`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.typed-array.every.js), [`es.typed-array.fill`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.typed-array.fill.js), [`es.typed-array.filter`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.typed-array.filter.js), [`es.typed-array.find`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.typed-array.find.js), [`es.typed-array.find-index`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.typed-array.find-index.js), [`es.typed-array.find-last`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.typed-array.find-last.js), [`es.typed-array.find-last-index`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.typed-array.find-last-index.js), [`es.typed-array.for-each`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.typed-array.for-each.js), [`es.typed-array.from`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.typed-array.from.js), [`es.typed-array.includes`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.typed-array.includes.js), [`es.typed-array.index-of`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.typed-array.index-of.js), [`es.typed-array.iterator`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.typed-array.iterator.js), [`es.typed-array.last-index-of`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.typed-array.last-index-of.js), [`es.typed-array.map`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.typed-array.map.js), [`es.typed-array.of`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.typed-array.of.js), [`es.typed-array.reduce`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.typed-array.reduce.js), [`es.typed-array.reduce-right`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.typed-array.reduce-right.js), [`es.typed-array.reverse`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.typed-array.reverse.js), [`es.typed-array.set`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.typed-array.set.js), [`es.typed-array.slice`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.typed-array.slice.js), [`es.typed-array.some`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.typed-array.some.js), [`es.typed-array.sort`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.typed-array.sort.js), [`es.typed-array.subarray`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.typed-array.subarray.js), [`es.typed-array.to-locale-string`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.typed-array.to-locale-string.js), [`es.typed-array.to-string`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.typed-array.to-string.js), [`es.typed-array.at`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.typed-array.at.js), [`es.typed-array.to-reversed`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.typed-array.to-reversed.js), [`es.typed-array.to-sorted`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.typed-array.to-sorted.js), [`es.typed-array.with`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.typed-array.with.js).
```js
class ArrayBuffer {
...
[*CommonJS entry points:*](#commonjs-api)
```
@hishprorg/eveniet-maxime/es|stable|actual|full/array-buffer
@hishprorg/eveniet-maxime/es|stable|actual|full/array-buffer/constructor
@hishprorg/eveniet-maxime/es|stable|actual|full/array-buffer/is-view
@hishprorg/eveniet-maxime/es|stable|actual|full/array-buffer/detached
@hishprorg/eveniet-maxime/es|stable|actual|full/array-buffer/slice
@hishprorg/eveniet-maxime/es|stable|actual|full/array-buffer/transfer
@hishprorg/eveniet-maxime/es|stable|actual|full/array-buffer/transfer-to-fixed-length
@hishprorg/eveniet-maxime/es|stable|actual|full/data-view
@hishprorg/eveniet-maxime/es|stable|actual|full/typed-array
@hishprorg/eveniet-maxime/es|stable|actual|full/typed-array/int8-array
@hishprorg/eveniet-maxime/es|stable|actual|full/typed-array/uint8-array
@hishprorg/eveniet-maxime/es|stable|actual|full/typed-array/uint8-clamped-array
@hishprorg/eveniet-maxime/es|stable|actual|full/typed-array/int16-array
@hishprorg/eveniet-maxime/es|stable|actual|full/typed-array/uint16-array
@hishprorg/eveniet-maxime/es|stable|actual|full/typed-array/int32-array
@hishprorg/eveniet-maxime/es|stable|actual|full/typed-array/uint32-array
@hishprorg/eveniet-maxime/es|stable|actual|full/typed-array/float32-array
@hishprorg/eveniet-maxime/es|stable|actual|full/typed-array/float64-array
@hishprorg/eveniet-maxime/es|stable|actual|full/typed-array/at
@hishprorg/eveniet-maxime/es|stable|actual|full/typed-array/copy-within
@hishprorg/eveniet-maxime/es|stable|actual|full/typed-array/entries
@hishprorg/eveniet-maxime/es|stable|actual|full/typed-array/every
@hishprorg/eveniet-maxime/es|stable|actual|full/typed-array/fill
@hishprorg/eveniet-maxime/es|stable|actual|full/typed-array/filter
@hishprorg/eveniet-maxime/es|stable|actual|full/typed-array/find
@hishprorg/eveniet-maxime/es|stable|actual|full/typed-array/find-index
@hishprorg/eveniet-maxime/es|stable|actual|full/typed-array/find-last
@hishprorg/eveniet-maxime/es|stable|actual|full/typed-array/find-last-index
@hishprorg/eveniet-maxime/es|stable|actual|full/typed-array/for-each
@hishprorg/eveniet-maxime/es|stable|actual|full/typed-array/from
@hishprorg/eveniet-maxime/es|stable|actual|full/typed-array/includes
@hishprorg/eveniet-maxime/es|stable|actual|full/typed-array/index-of
@hishprorg/eveniet-maxime/es|stable|actual|full/typed-array/iterator
@hishprorg/eveniet-maxime/es|stable|actual|full/typed-array/join
@hishprorg/eveniet-maxime/es|stable|actual|full/typed-array/keys
@hishprorg/eveniet-maxime/es|stable|actual|full/typed-array/last-index-of
@hishprorg/eveniet-maxime/es|stable|actual|full/typed-array/map
@hishprorg/eveniet-maxime/es|stable|actual|full/typed-array/of
@hishprorg/eveniet-maxime/es|stable|actual|full/typed-array/reduce
@hishprorg/eveniet-maxime/es|stable|actual|full/typed-array/reduce-right
@hishprorg/eveniet-maxime/es|stable|actual|full/typed-array/reverse
@hishprorg/eveniet-maxime/es|stable|actual|full/typed-array/set
@hishprorg/eveniet-maxime/es|stable|actual|full/typed-array/slice
@hishprorg/eveniet-maxime/es|stable|actual|full/typed-array/some
@hishprorg/eveniet-maxime/es|stable|actual|full/typed-array/sort
@hishprorg/eveniet-maxime/es|stable|actual|full/typed-array/subarray
@hishprorg/eveniet-maxime/es|stable|actual|full/typed-array/to-locale-string
@hishprorg/eveniet-maxime/es|stable|actual|full/typed-array/to-reversed
@hishprorg/eveniet-maxime/es|stable|actual|full/typed-array/to-sorted
@hishprorg/eveniet-maxime/es|stable|actual|full/typed-array/to-string
@hishprorg/eveniet-maxime/es|stable|actual|full/typed-array/values
@hishprorg/eveniet-maxime/es|stable|actual|full/typed-array/with
```
...
Modules [`es.reflect.apply`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.reflect.apply.js), [`es.reflect.construct`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.reflect.construct.js), [`es.reflect.define-property`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.reflect.define-property.js), [`es.reflect.delete-property`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.reflect.delete-property.js), [`es.reflect.get`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.reflect.get.js), [`es.reflect.get-own-property-descriptor`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.reflect.get-own-property-descriptor.js), [`es.reflect.get-prototype-of`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.reflect.get-prototype-of.js), [`es.reflect.has`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.reflect.has.js), [`es.reflect.is-extensible`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.reflect.is-extensible.js), [`es.reflect.own-keys`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.reflect.own-keys.js), [`es.reflect.prevent-extensions`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.reflect.prevent-extensions.js), [`es.reflect.set`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.reflect.set.js), [`es.reflect.set-prototype-of`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.reflect.set-prototype-of.js).
```js
namespace Reflect {
...
[*CommonJS entry points:*](#commonjs-api)
```
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/reflect
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/reflect/apply
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/reflect/construct
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/reflect/define-property
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/reflect/delete-property
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/reflect/get
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/reflect/get-own-property-descriptor
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/reflect/get-prototype-of
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/reflect/has
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/reflect/is-extensible
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/reflect/own-keys
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/reflect/prevent-extensions
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/reflect/set
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/reflect/set-prototype-of
```
...
Since `JSON` object is missed only in very old engines like IE7-, `@hishprorg/eveniet-maxime` does not provide a full `JSON` polyfill, however, fix already existing implementations by the current standard, for example, [well-formed `JSON.stringify`](https://github.com/tc39/proposal-well-formed-stringify). `JSON` is also fixed in other modules - for example, `Symbol` polyfill fixes `JSON.stringify` for correct work with symbols.

Module [`es.json.to-string-tag`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.json.to-string-tag.js) and [`es.json.stringify`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.json.stringify.js).
```js
namespace JSON {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/json/stringify
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/json/to-string-tag
```
...
Module [`es.global-this`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/es.global-this.js).
```js
let globalThis: GlobalThisValue;
```
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/global-this
```
...
Finished (stage 4) proposals already marked in `@hishprorg/eveniet-maxime` as stable ECMAScript, they are available in `@hishprorg/eveniet-maxime/stable` and `@hishprorg/eveniet-maxime/es` namespace, you can find them in related sections of the README. However, even for finished proposals, `@hishprorg/eveniet-maxime` provides a way to include only features for a specific proposal like `@hishprorg/eveniet-maxime/proposals/proposal-name`.
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime/proposals/global-this
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@hishprorg/eveniet-maxime/proposals/relative-indexing-method
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@hishprorg/eveniet-maxime/proposals/array-includes
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@hishprorg/eveniet-maxime/proposals/array-flat-map
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@hishprorg/eveniet-maxime/proposals/array-find-from-last
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@hishprorg/eveniet-maxime/proposals/change-array-by-copy-stage-4
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/array(/virtual)/to-reversed
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/array(/virtual)/to-sorted
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/array(/virtual)/to-spliced
@hishprorg/eveniet-maxime(-pure)/es|stable|actual|full/array(/virtual)/with
...
[*CommonJS entry points:*](#commonjs-api)
```
@hishprorg/eveniet-maxime/proposals/array-grouping-v2
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime/proposals/array-buffer-transfer
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@hishprorg/eveniet-maxime/proposals/object-values-entries
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@hishprorg/eveniet-maxime/proposals/object-from-entries
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@hishprorg/eveniet-maxime/proposals/object-getownpropertydescriptors
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@hishprorg/eveniet-maxime/proposals/accessible-object-hasownproperty
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@hishprorg/eveniet-maxime/proposals/string-padding
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime/proposals/string-match-all
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime/proposals/string-replace-all-stage-4
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime/proposals/string-left-right-trim
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime/proposals/regexp-dotall-flag
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime/proposals/regexp-named-groups
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime/proposals/promise-all-settled
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime/proposals/promise-any
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime/proposals/promise-finally
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime/proposals/promise-with-resolvers
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime/proposals/async-iteration
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime/proposals/symbol-description
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime/proposals/well-formed-stringify
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime/proposals/well-formed-unicode-strings
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime/proposals/set-methods-v2
```

#### Stage 3 proposals[⬆](#index)

`@hishprorg/eveniet-maxime/stage/3` entry point contains only stage 3 proposals, `@hishprorg/eveniet-maxime/stage/2.7` - stage 2.7 and stage 3, etc.

[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime(-pure)/stage/3
```
##### [`Iterator` helpers](https://github.com/tc39/proposal-iterator-helpers)[⬆](#index)
Modules [`esnext.iterator.constructor`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.iterator.constructor.js), [`esnext.iterator.drop`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.iterator.drop.js), [`esnext.iterator.every`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.iterator.every.js), [`esnext.iterator.filter`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.iterator.filter.js), [`esnext.iterator.find`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.iterator.find.js), [`esnext.iterator.flat-map`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.iterator.flat-map.js), [`esnext.iterator.for-each`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.iterator.for-each.js), [`esnext.iterator.from`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.iterator.from.js), [`esnext.iterator.map`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.iterator.map.js), [`esnext.iterator.reduce`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.iterator.reduce.js), [`esnext.iterator.some`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.iterator.some.js), [`esnext.iterator.take`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.iterator.take.js), [`esnext.iterator.to-array`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.iterator.to-array.js)
```js
class Iterator {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime/proposals/iterator-helpers-stage-3-2
@hishprorg/eveniet-maxime(-pure)/actual|full/iterator
@hishprorg/eveniet-maxime(-pure)/actual|full/iterator/drop
@hishprorg/eveniet-maxime(-pure)/actual|full/iterator/every
@hishprorg/eveniet-maxime(-pure)/actual|full/iterator/filter
@hishprorg/eveniet-maxime(-pure)/actual|full/iterator/find
@hishprorg/eveniet-maxime(-pure)/actual|full/iterator/flat-map
@hishprorg/eveniet-maxime(-pure)/actual|full/iterator/for-each
@hishprorg/eveniet-maxime(-pure)/actual|full/iterator/from
@hishprorg/eveniet-maxime(-pure)/actual|full/iterator/map
@hishprorg/eveniet-maxime(-pure)/actual|full/iterator/reduce
@hishprorg/eveniet-maxime(-pure)/actual|full/iterator/some
@hishprorg/eveniet-maxime(-pure)/actual|full/iterator/take
@hishprorg/eveniet-maxime(-pure)/actual|full/iterator/to-array
```
...
Modules [`esnext.array.from-async`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.array.from-async.js).
```js
class Array {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime/proposals/array-from-async-stage-2
@hishprorg/eveniet-maxime(-pure)/actual|full/array/from-async
```
...
Modules [`esnext.json.is-raw-json`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.json.is-raw-json.js), [`esnext.json.parse`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.json.parse.js), [`esnext.json.raw-json`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.json.raw-json.js).
```js
namespace JSON {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime/proposals/json-parse-with-source
@hishprorg/eveniet-maxime(-pure)/actual|full/json/is-raw-json
@hishprorg/eveniet-maxime(-pure)/actual|full/json/parse
@hishprorg/eveniet-maxime(-pure)/actual|full/json/raw-json
@hishprorg/eveniet-maxime(-pure)/actual|full/json/stringify
```
...
Modules [`esnext.data-view.get-float16`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.data-view.get-float16.js), [`esnext.data-view.set-float16`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.data-view.set-float16.js) and [`esnext.math.f16round`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.math.f16round.js)
```js
class DataView {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime/proposals/float16
@hishprorg/eveniet-maxime/actual|full/dataview/get-float16
@hishprorg/eveniet-maxime/actual|full/dataview/set-float16
@hishprorg/eveniet-maxime/actual|full/math/f16round
```
...
Modules [`esnext.uint8-array.from-base64`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.uint8-array.from-base64.js), [`esnext.uint8-array.from-hex`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.uint8-array.from-hex.js), [`esnext.uint8-array.to-base64`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.uint8-array.to-base64.js), [`esnext.uint8-array.to-hex`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.uint8-array.to-hex.js).
```js
class Uint8Array {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime/proposals/array-buffer-base64
@hishprorg/eveniet-maxime(-pure)/full/typed-array/from-base64
@hishprorg/eveniet-maxime(-pure)/full/typed-array/from-hex
@hishprorg/eveniet-maxime(-pure)/full/typed-array/to-base64
@hishprorg/eveniet-maxime(-pure)/full/typed-array/to-hex
```
*Example*:
```js
...
Modules [`esnext.symbol.dispose`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.symbol.dispose.js), [`esnext.disposable-stack.constructor`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.disposable-stack.constructor.js), [`esnext.suppressed-error.constructor`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.suppressed-error.constructor.js), [`esnext.iterator.dispose`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.iterator.dispose.js), [`esnext.symbol.async-dispose`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.symbol.async-dispose.js), [`esnext.async-disposable-stack.constructor`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.async-disposable-stack.constructor.js), [`esnext.async-iterator.async-dispose`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.async-iterator.async-dispose.js).
```js
class Symbol {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime/proposals/explicit-resource-management
@hishprorg/eveniet-maxime(-pure)/actual|full/symbol/async-dispose
@hishprorg/eveniet-maxime(-pure)/actual|full/symbol/dispose
@hishprorg/eveniet-maxime(-pure)/actual|full/disposable-stack
@hishprorg/eveniet-maxime(-pure)/actual|full/async-disposable-stack
@hishprorg/eveniet-maxime(-pure)/actual|full/suppressed-error
@hishprorg/eveniet-maxime(-pure)/actual|full/iterator/dispose
@hishprorg/eveniet-maxime(-pure)/actual|full/async-iterator/async-dispose
```
##### [`Symbol.metadata` for decorators metadata proposal](https://github.com/tc39/proposal-decorator-metadata)[⬆](#index)
Modules [`esnext.symbol.metadata`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.symbol.metadata.js) and [`esnext.function.metadata`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.function.metadata.js).
```js
class Symbol {
...
[*CommonJS entry points:*](#commonjs-api)
```
@hishprorg/eveniet-maxime/proposals/decorator-metadata-v2
@hishprorg/eveniet-maxime(-pure)/actual|full/symbol/metadata
@hishprorg/eveniet-maxime(-pure)/actual|full/function/metadata
```

#### Stage 2.7 proposals[⬆](#index)
[*CommonJS entry points:*](#commonjs-api)
```
@hishprorg/eveniet-maxime(-pure)/stage/2.7
```

##### [`Promise.try`](https://github.com/tc39/proposal-promise-try)
Module [`esnext.promise.try`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.promise.try.js)
```js
class Promise {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime/proposals/promise-try
@hishprorg/eveniet-maxime(-pure)/full/promise/try
```
...
Module [`esnext.math.sum-precise`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.math.sum-precise.js)
```js
class Math {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime/proposals/math-sum
@hishprorg/eveniet-maxime(-pure)/full/math/sum-precise
```
...
[*CommonJS entry points:*](#commonjs-api)
```
@hishprorg/eveniet-maxime(-pure)/stage/2
```
##### [`AsyncIterator` helpers](https://github.com/tc39/proposal-async-iterator-helpers)[⬆](#index)
Modules [`esnext.async-iterator.constructor`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.async-iterator.constructor.js), [`esnext.async-iterator.drop`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.async-iterator.drop.js), [`esnext.async-iterator.every`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.async-iterator.every.js), [`esnext.async-iterator.filter`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.async-iterator.filter.js), [`esnext.async-iterator.find`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.async-iterator.find.js), [`esnext.async-iterator.flat-map`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.async-iterator.flat-map.js), [`esnext.async-iterator.for-each`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.async-iterator.for-each.js), [`esnext.async-iterator.from`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.async-iterator.from.js), [`esnext.async-iterator.map`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.async-iterator.map.js), [`esnext.async-iterator.reduce`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.async-iterator.reduce.js), [`esnext.async-iterator.some`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.async-iterator.some.js), [`esnext.async-iterator.take`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.async-iterator.take.js), [`esnext.async-iterator.to-array`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.async-iterator.to-array.js), , [`esnext.iterator.to-async`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.iterator.to-async.js)
```js
class Iterator {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime/proposals/async-iterator-helpers
@hishprorg/eveniet-maxime(-pure)/actual|full/async-iterator
@hishprorg/eveniet-maxime(-pure)/actual|full/async-iterator/drop
@hishprorg/eveniet-maxime(-pure)/actual|full/async-iterator/every
@hishprorg/eveniet-maxime(-pure)/actual|full/async-iterator/filter
@hishprorg/eveniet-maxime(-pure)/actual|full/async-iterator/find
@hishprorg/eveniet-maxime(-pure)/actual|full/async-iterator/flat-map
@hishprorg/eveniet-maxime(-pure)/actual|full/async-iterator/for-each
@hishprorg/eveniet-maxime(-pure)/actual|full/async-iterator/from
@hishprorg/eveniet-maxime(-pure)/actual|full/async-iterator/map
@hishprorg/eveniet-maxime(-pure)/actual|full/async-iterator/reduce
@hishprorg/eveniet-maxime(-pure)/actual|full/async-iterator/some
@hishprorg/eveniet-maxime(-pure)/actual|full/async-iterator/take
@hishprorg/eveniet-maxime(-pure)/actual|full/async-iterator/to-array
@hishprorg/eveniet-maxime(-pure)/actual|full/iterator/to-async
```
...
Module [`esnext.iterator.range`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.iterator.range.js)
```js
class Iterator {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime/proposals/number-range
@hishprorg/eveniet-maxime(-pure)/full/iterator/range
```
...
Modules [`esnext.map.emplace`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.map.emplace.js) and [`esnext.weak-map.emplace`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.weak-map.emplace.js)
```js
class Map {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime/proposals/map-upsert-stage-2
@hishprorg/eveniet-maxime(-pure)/full/map/emplace
@hishprorg/eveniet-maxime(-pure)/full/weak-map/emplace
```
...
Module [`esnext.array.is-template-object`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.array.is-template-object.js)
```js
class Array {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime/proposals/array-is-template-object
@hishprorg/eveniet-maxime(-pure)/full/array/is-template-object
```
*Example*:
```js
...
Module [`esnext.string.dedent`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.string.dedent.js)
```js
class String {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime/proposals/string-dedent
@hishprorg/eveniet-maxime(-pure)/full/string/dedent
```
...
Module [`esnext.regexp.escape`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.regexp.escape.js)
```js
class RegExp {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime/proposals/regexp-escaping
@hishprorg/eveniet-maxime(-pure)/full/regexp/escape
```
...
Modules [`esnext.symbol.is-registered-symbol`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.symbol.is-registered-symbol.js), [`esnext.symbol.is-well-known-symbol`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.symbol.is-well-known-symbol.js).
```js
class Symbol {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime/proposals/symbol-predicates-v2
@hishprorg/eveniet-maxime(-pure)/full/symbol/is-registered-symbol
@hishprorg/eveniet-maxime(-pure)/full/symbol/is-well-known-symbol
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime(-pure)/stage/1
```
##### [`Observable`](https://github.com/zenparsing/es-observable)[⬆](#index)
Modules [`esnext.observable`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.observable.js) and [`esnext.symbol.observable`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.symbol.observable.js)
```js
class Observable {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime/proposals/observable
@hishprorg/eveniet-maxime(-pure)/full/observable
@hishprorg/eveniet-maxime(-pure)/full/symbol/observable
```
...
Modules [`esnext.set.add-all`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.set.add-all.js), [`esnext.set.delete-all`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.set.delete-all.js), [`esnext.set.every`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.set.every.js), [`esnext.set.filter`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.set.filter.js), [`esnext.set.find`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.set.find.js), [`esnext.set.join`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.set.join.js), [`esnext.set.map`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.set.map.js), [`esnext.set.reduce`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.set.reduce.js), [`esnext.set.some`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.set.some.js), [`esnext.map.delete-all`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.map.delete-all.js), [`esnext.map.every`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.map.every.js), [`esnext.map.filter`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.map.filter.js), [`esnext.map.find`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.map.find.js), [`esnext.map.find-key`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.map.find-key.js), [`esnext.map.includes`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.map.includes.js), [`esnext.map.key-by`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.map.key-by.js), [`esnext.map.key-of`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.map.key-of.js), [`esnext.map.map-keys`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.map.map-keys.js), [`esnext.map.map-values`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.map.map-values.js), [`esnext.map.merge`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.map.merge.js), [`esnext.map.reduce`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.map.reduce.js), [`esnext.map.some`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.map.some.js), [`esnext.map.update`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.map.update.js), [`esnext.weak-set.add-all`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.weak-set.add-all.js), [`esnext.weak-set.delete-all`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.weak-set.delete-all.js), [`esnext.weak-map.delete-all`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.weak-map.delete-all.js)
##### [`.of` and `.from` methods on collection constructors](https://github.com/tc39/proposal-setmap-offrom)[⬆](#index)
Modules [`esnext.set.of`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.set.of.js), [`esnext.set.from`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.set.from.js), [`esnext.map.of`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.map.of.js), [`esnext.map.from`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.map.from.js), [`esnext.weak-set.of`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.weak-set.of.js), [`esnext.weak-set.from`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.weak-set.from.js), [`esnext.weak-map.of`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.weak-map.of.js), [`esnext.weak-map.from`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.weak-map.from.js)
```js
class Set {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime/proposals/collection-methods
@hishprorg/eveniet-maxime/proposals/collection-of-from
@hishprorg/eveniet-maxime(-pure)/full/set/add-all
@hishprorg/eveniet-maxime(-pure)/full/set/delete-all
@hishprorg/eveniet-maxime(-pure)/full/set/every
@hishprorg/eveniet-maxime(-pure)/full/set/filter
@hishprorg/eveniet-maxime(-pure)/full/set/find
@hishprorg/eveniet-maxime(-pure)/full/set/from
@hishprorg/eveniet-maxime(-pure)/full/set/join
@hishprorg/eveniet-maxime(-pure)/full/set/map
@hishprorg/eveniet-maxime(-pure)/full/set/of
@hishprorg/eveniet-maxime(-pure)/full/set/reduce
@hishprorg/eveniet-maxime(-pure)/full/set/some
@hishprorg/eveniet-maxime(-pure)/full/map/delete-all
@hishprorg/eveniet-maxime(-pure)/full/map/every
@hishprorg/eveniet-maxime(-pure)/full/map/filter
@hishprorg/eveniet-maxime(-pure)/full/map/find
@hishprorg/eveniet-maxime(-pure)/full/map/find-key
@hishprorg/eveniet-maxime(-pure)/full/map/from
@hishprorg/eveniet-maxime(-pure)/full/map/includes
@hishprorg/eveniet-maxime(-pure)/full/map/key-by
@hishprorg/eveniet-maxime(-pure)/full/map/key-of
@hishprorg/eveniet-maxime(-pure)/full/map/map-keys
@hishprorg/eveniet-maxime(-pure)/full/map/map-values
@hishprorg/eveniet-maxime(-pure)/full/map/merge
@hishprorg/eveniet-maxime(-pure)/full/map/of
@hishprorg/eveniet-maxime(-pure)/full/map/reduce
@hishprorg/eveniet-maxime(-pure)/full/map/some
@hishprorg/eveniet-maxime(-pure)/full/map/update
@hishprorg/eveniet-maxime(-pure)/full/weak-set/add-all
@hishprorg/eveniet-maxime(-pure)/full/weak-set/delete-all
@hishprorg/eveniet-maxime(-pure)/full/weak-set/of
@hishprorg/eveniet-maxime(-pure)/full/weak-set/from
@hishprorg/eveniet-maxime(-pure)/full/weak-map/delete-all
@hishprorg/eveniet-maxime(-pure)/full/weak-map/of
@hishprorg/eveniet-maxime(-pure)/full/weak-map/from
```
...
Modules [`esnext.composite-key`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.composite-key.js) and [`esnext.composite-symbol`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.composite-symbol.js)
```js
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime/proposals/keys-composition
@hishprorg/eveniet-maxime(-pure)/full/composite-key
@hishprorg/eveniet-maxime(-pure)/full/composite-symbol
```
...
Modules [`esnext.array.filter-reject`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.array.filter-reject.js) and [`esnext.typed-array.filter-reject`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.typed-array.filter-reject.js).
```js
class Array {
...
[*CommonJS entry points:*](#commonjs-api)
```
@hishprorg/eveniet-maxime/proposals/array-filtering-stage-1
@hishprorg/eveniet-maxime(-pure)/full/array(/virtual)/filter-reject
@hishprorg/eveniet-maxime/full/typed-array/filter-reject
```
...
Modules [`esnext.array.unique-by`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.array.unique-by.js) and [`esnext.typed-array.unique-by`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.typed-array.unique-by.js)
```js
class Array {
...
[*CommonJS entry points:*](#commonjs-api)
```
@hishprorg/eveniet-maxime/proposals/array-unique
@hishprorg/eveniet-maxime(-pure)/full/array(/virtual)/unique-by
@hishprorg/eveniet-maxime/full/typed-array/unique-by
```
...
Modules [`esnext.data-view.get-uint8-clamped`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.data-view.get-uint8-clamped.js) and [`esnext.data-view.set-uint8-clamped`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.data-view.set-uint8-clamped.js)
```js
class DataView {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime/proposals/data-view-get-set-uint8-clamped
@hishprorg/eveniet-maxime/full/dataview/get-uint8-clamped
@hishprorg/eveniet-maxime/full/dataview/set-uint8-clamped
```
...
Module [`esnext.number.from-string`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.number.from-string.js)
```js
class Number {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime/proposals/number-from-string
@hishprorg/eveniet-maxime(-pure)/full/number/from-string
```

##### [`String.cooked`](https://github.com/tc39/proposal-string-cooked)[⬆](#index)
Module [`esnext.string.cooked`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.string.cooked.js)
```js
class String {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime/proposals/string-cooked
@hishprorg/eveniet-maxime(-pure)/full/string/cooked
```
...
Module [`esnext.string.code-points`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.string.code-points.js)
```js
class String {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime/proposals/string-code-points
@hishprorg/eveniet-maxime(-pure)/full/string/code-points
```
[*Example*](https://goo.gl/Jt7SsD):
```js
...
Module [`esnext.symbol.custom-matcher`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.symbol.custom-matcher.js).
```js
class Symbol {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime/proposals/pattern-matching-v2
@hishprorg/eveniet-maxime(-pure)/full/symbol/custom-matcher
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime/proposals/pattern-extractors
@hishprorg/eveniet-maxime(-pure)/full/symbol/custom-matcher
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime(-pure)/stage/0
```
##### [`Function.prototype.demethodize`](https://github.com/js-choi/proposal-function-demethodize)[⬆](#index)
Module [`esnext.function.demethodize`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.function.demethodize.js)
```js
class Function {
...
[*CommonJS entry points:*](#commonjs-api)
```
@hishprorg/eveniet-maxime/proposals/function-demethodize
@hishprorg/eveniet-maxime(-pure)/full/function/demethodize
@hishprorg/eveniet-maxime(-pure)/full/function/virtual/demethodize
```
...
Modules [`esnext.function.is-callable`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.function.is-callable.js), [`esnext.function.is-constructor`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.function.is-constructor.js)
```js
class Function {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime/proposals/function-is-callable-is-constructor
@hishprorg/eveniet-maxime(-pure)/full/function/is-callable
@hishprorg/eveniet-maxime(-pure)/full/function/is-constructor
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime(-pure)/stage/pre
```
##### [`Reflect` metadata](https://github.com/rbuckton/reflect-metadata)[⬆](#index)
Modules [`esnext.reflect.define-metadata`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.reflect.define-metadata.js), [`esnext.reflect.delete-metadata`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.reflect.delete-metadata.js), [`esnext.reflect.get-metadata`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.reflect.get-metadata.js), [`esnext.reflect.get-metadata-keys`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.reflect.get-metadata-keys.js), [`esnext.reflect.get-own-metadata`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.reflect.get-own-metadata.js), [`esnext.reflect.get-own-metadata-keys`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.reflect.get-own-metadata-keys.js), [`esnext.reflect.has-metadata`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.reflect.has-metadata.js), [`esnext.reflect.has-own-metadata`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.reflect.has-own-metadata.js) and [`esnext.reflect.metadata`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/esnext.reflect.metadata.js).
```js
namespace Reflect {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime/proposals/reflect-metadata
@hishprorg/eveniet-maxime(-pure)/full/reflect/define-metadata
@hishprorg/eveniet-maxime(-pure)/full/reflect/delete-metadata
@hishprorg/eveniet-maxime(-pure)/full/reflect/get-metadata
@hishprorg/eveniet-maxime(-pure)/full/reflect/get-metadata-keys
@hishprorg/eveniet-maxime(-pure)/full/reflect/get-own-metadata
@hishprorg/eveniet-maxime(-pure)/full/reflect/get-own-metadata-keys
@hishprorg/eveniet-maxime(-pure)/full/reflect/has-metadata
@hishprorg/eveniet-maxime(-pure)/full/reflect/has-own-metadata
@hishprorg/eveniet-maxime(-pure)/full/reflect/metadata
```
...
### Web standards[⬆](#index)
#### `self`[⬆](#index)
[Spec](https://html.spec.whatwg.org/multipage/window-object.html#dom-self), module [`web.self`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/web.self.js)
```js
getter self: GlobalThisValue;
```
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime(-pure)/stable|actual|full/self
```
...
[Spec](https://html.spec.whatwg.org/multipage/structured-data.html#dom-structuredclone), module [`web.structured-clone`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/web.structured-clone.js)
```js
function structuredClone(value: Serializable, { transfer?: Sequence<Transferable> }): any;
```
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime(-pure)/stable|actual|full/structured-clone
```
...
> - Some specific platform types can't be cloned in old engines. Mainly it's very specific types or very old engines, but here are some exceptions. For example, we have no sync way to clone `ImageBitmap` in Safari 14.0- or Firefox 83-, so it's recommended to look to the [polyfill source](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/web.structured-clone.js) if you wanna clone something specific.

#### Base64 utility methods[⬆](#index)
[Specification](https://html.spec.whatwg.org/multipage/webappapis.html#atob), [MDN](https://developer.mozilla.org/en-US/docs/Glossary/Base64). Modules [`web.atob`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/web.atob.js), [`web.btoa`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/web.btoa.js).
```js
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime(-pure)/stable|actual|full/atob
@hishprorg/eveniet-maxime(-pure)/stable|actual|full/btoa
```
[*Examples*](https://is.gd/4Nxmzn):
```js
btoa('hi, @hishprorg/eveniet-maxime');      // => 'aGksIGNvcmUtanM='
atob('aGksIGNvcmUtanM='); // => 'hi, @hishprorg/eveniet-maxime'
```

#### `setTimeout` and `setInterval`[⬆](#index)
Module [`web.timers`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/web.timers.js). Additional arguments fix for IE9-.
```js
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime(-pure)/stable|actual|full/set-timeout
@hishprorg/eveniet-maxime(-pure)/stable|actual|full/set-interval
```
```js
// Before:
...
```
#### `setImmediate`[⬆](#index)
Module [`web.immediate`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/web.immediate.js). [`setImmediate`](https://w3c.github.io/setImmediate/) polyfill.
```js
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime(-pure)/stable|actual|full/set-immediate
@hishprorg/eveniet-maxime(-pure)/stable|actual|full/clear-immediate
```
...
[Spec](https://html.spec.whatwg.org/multipage/timers-and-user-prompts.html#dom-queuemicrotask), module [`web.queue-microtask`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/web.queue-microtask.js)
```js
function queueMicrotask(fn: Function): void;
```
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime(-pure)/stable|actual|full/queue-microtask
```
...
[`URL` standard](https://url.spec.whatwg.org/) implementation. Modules [`web.url`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/web.url.js), [`web.url.can-parse`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/web.url.can-parse.js), [`web.url.parse`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/web.url.parse.js), [`web.url.to-json`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/web.url.to-json.js), [`web.url-search-params`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/web.url-search-params.js), [`web.url-search-params.delete`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/web.url-search-params.delete.js), [`web.url-search-params.has`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/web.url-search-params.has.js), [`web.url-search-params.size`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/web.url-search-params.size.js).
```js
class URL {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime/proposals/url
@hishprorg/eveniet-maxime(-pure)/stable|actual|full/url
@hishprorg/eveniet-maxime(-pure)/stable|actual|full/url/can-parse
@hishprorg/eveniet-maxime/stable|actual|full/url/to-json
@hishprorg/eveniet-maxime(-pure)/stable|actual|full/url-search-params
```
...
> - Legacy encodings in a search query are not supported. Also, `@hishprorg/eveniet-maxime` implementation has some other encoding-related issues.
> - `URL` implementations from all of the popular browsers have significantly more problems than `@hishprorg/eveniet-maxime`, however, replacing all of them does not look like a good idea. You can customize the aggressiveness of polyfill [by your requirements](#configurable-level-of-aggressiveness).

##### `DOMException`:[⬆](#index)
[The specification.](https://webidl.spec.whatwg.org/#idl-DOMException) Modules [`web.dom-exception.constructor`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/web.dom-exception.constructor.js), [`web.dom-exception.stack`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/web.dom-exception.stack.js), [`web.dom-exception.to-string-tag`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/web.dom-exception.to-string-tag.js).
```js
class DOMException {
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime(-pure)/stable|actual|full/dom-exception
@hishprorg/eveniet-maxime(-pure)/stable|actual|full/dom-exception/constructor
@hishprorg/eveniet-maxime/stable|actual|full/dom-exception/to-string-tag
```
...
Some DOM collections should have [iterable interface](https://heycam.github.io/webidl/#idl-iterable) or should be [inherited from `Array`](https://heycam.github.io/webidl/#LegacyArrayClass). That means they should have `forEach`, `keys`, `values`, `entries` and `@@iterator` methods for iteration. So add them. Modules [`web.dom-collections.iterator`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/web.dom-collections.iterator.js) and [`web.dom-collections.for-each`](https://github.com/hishprorg/eveniet-maxime/blob/master/packages/@hishprorg/eveniet-maxime/modules/web.dom-collections.for-each.js).
```js
class [
  CSSRuleList,
  CSSStyleDeclaration,
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime(-pure)/stable|actual|full/dom-collections/iterator
@hishprorg/eveniet-maxime/stable|actual|full/dom-collections/for-each
```
...
[*CommonJS entry points:*](#commonjs-api)
```js
@hishprorg/eveniet-maxime-pure/es|stable|actual|full/is-iterable
@hishprorg/eveniet-maxime-pure/es|stable|actual|full/get-iterator
@hishprorg/eveniet-maxime-pure/es|stable|actual|full/get-iterator-method
```
[*Examples*](https://goo.gl/SXsM6D):
```js
import isIterable from '@hishprorg/eveniet-maxime-pure/actual/is-iterable';
import getIterator from '@hishprorg/eveniet-maxime-pure/actual/get-iterator';
import getIteratorMethod from '@hishprorg/eveniet-maxime-pure/actual/get-iterator-method';
...
- ES `BigInt` can't be polyfilled since it requires changes in the behavior of operators, you can find more info [here](https://github.com/hishprorg/eveniet-maxime/issues/381). You could try to use [`JSBI`](https://github.com/GoogleChromeLabs/jsbi).
...
- `window.fetch` is not a cross-platform feature, in some environments, it makes no sense. For this reason, I don't think it should be in `@hishprorg/eveniet-maxime`. Looking at a large number of requests it *might be*  added in the future. Now you can use, for example, [this polyfill](https://github.com/github/fetch).
